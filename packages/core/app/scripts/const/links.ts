const Links: Readonly<Record<string, string>> = {
    Homepage: 'https://github.com/gynet/keewebx',
    Repo: 'https://github.com/gynet/keewebx',
    WebApp: 'https://keewebx.app/app',
    Releases: 'https://github.com/gynet/keewebx/releases',
